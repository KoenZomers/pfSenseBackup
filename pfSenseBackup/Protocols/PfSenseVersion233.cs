...
{
    /// <summary>
    /// Implementation of the pfSense protocol for version 2.3.3
    /// </summary>
    public class PfSenseVersion233 : IPfSenseProtocol
    {
        /// <summary>
        /// Connects with the specified pfSense server using the v2.3.3 protocol implementation and returns the backup file contents
        /// </summary>
