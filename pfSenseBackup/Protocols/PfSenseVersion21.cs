...
{
    /// <summary>
    /// Implementation of the pfSense protocol for version 2.1 and version 2.2
    /// </summary>
    public class PfSenseVersion21 : IPfSenseProtocol
    {
        /// <summary>
        /// Connects with the specified pfSense server using the v2.1 and v2.2 protocol implementation and returns the backup file contents
        /// </summary>
