...
{
    /// <summary>
    /// Implementation of the pfSense protocol for version 2.7.0
    /// </summary>
    public class PfSenseVersion270 : IPfSenseProtocol
    {
        /// <summary>
        /// Connects with the specified pfSense server using the v2.7.0 protocol implementation and returns the backup file contents
        /// </summary>
            ...
            var downloadArgs = new Dictionary<string, string>
                {
                    ...
                    { "backupdata", pfSenseServer.BackupExtraData ? "yes" : "" },
